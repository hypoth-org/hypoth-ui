...
const BreadcrumbRoot = forwardRef<HTMLElement, BreadcrumbRootProps>(
  function BreadcrumbRoot({ children, className, ...props }, ref) {
...
const BreadcrumbList = forwardRef<HTMLElement, BreadcrumbListProps>(
  function BreadcrumbList({ children, className, ...props }, ref) {
...
const BreadcrumbItem = forwardRef<HTMLElement, BreadcrumbItemProps>(
  function BreadcrumbItem({ children, className, ...props }, ref) {
...
const BreadcrumbLink = forwardRef<HTMLElement, BreadcrumbLinkProps>(
  function BreadcrumbLink({ children, className, href, onNavigate, ...props }, ref) {
    ...
    return createElement("ds-breadcrumb-link", { ref: combinedRef, class: className, href, ...props }, children);
  }
);
BreadcrumbLink.displayName = "Breadcrumb.Link";

const BreadcrumbPage = forwardRef<HTMLElement, BreadcrumbPageProps>(
  function BreadcrumbPage({ children, className, ...props }, ref) {
