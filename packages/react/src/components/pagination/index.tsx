...
const PaginationRoot = forwardRef<HTMLElement, PaginationRootProps>(
  function PaginationRoot({ children, className, page: controlledPage, defaultPage = 1, totalPages = 1, onPageChange, ...props }, ref) {
    ...
    return createElement("ds-pagination", { ref: combinedRef, class: className, page, "total-pages": totalPages, ...props }, children);
  }
);
...
const PaginationItem = forwardRef<HTMLElement, PaginationItemProps>(
  function PaginationItem({ children, className, ...props }, ref) {
    return createElement("ds-pagination-item", { ref, class: className, ...props }, children);
  }
);
PaginationItem.displayName = "Pagination.Item";

const PaginationLink = forwardRef<HTMLElement, PaginationLinkProps>(
  function PaginationLink({ children, className, page, active, ...props }, ref) {
    return createElement("ds-pagination-link", { ref, class: className, page, active: active || undefined, ...props }, children);
  }
);
...
const PaginationPrevious = forwardRef<HTMLElement, PaginationPreviousProps>(
  function PaginationPrevious({ children, className, disabled, ...props }, ref) {
    return createElement("ds-pagination-previous", { ref, class: className, disabled: disabled || undefined, ...props }, children);
  }
);
PaginationPrevious.displayName = "Pagination.Previous";

const PaginationNext = forwardRef<HTMLElement, PaginationNextProps>(
  function PaginationNext({ children, className, disabled, ...props }, ref) {
    return createElement("ds-pagination-next", { ref, class: className, disabled: disabled || undefined, ...props }, children);
  }
);
